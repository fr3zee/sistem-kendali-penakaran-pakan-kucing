...
| MAE_pct | Mean Absolute Error (%) terhadap setpoint |
...
| BridgingCount | Jumlah aktivasi mekanisme anti-bridging |
| Valid | TRUE jika trial memenuhi kriteria validasi |
| StopReason | Alasan berhenti: TARGET (normal) |

### Catatan

- Raw log 160 trial (.txt) tidak disertakan; tersimpan sebagai arsip internal.
