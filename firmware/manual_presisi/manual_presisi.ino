/**
 * MANUAL PRESISI - PET FEEDER
 * ============================
 * Skenario open-loop: sudut bukaan servo tetap 20° sepanjang proses dispensing.
 ...
 * Perilaku dan parameter ekuivalen terhadap skenario Manual Presisi pada
 * pengujian yang menghasilkan master_dataset_160.csv.
 *
 * Parameter utama:
 *   - Sudut bukaan utama : 20°  ← satu-satunya perbedaan dari Manual Cepat
...
// ── Parameter ──────────────────────────────────────────────────────────────
const float  SERVO_OPEN_DEG      = 20.0f;   // bukaan utama Manual Presisi
const float  SERVO_CLOSE_DEG     =  0.0f;
const float  EARLY_STOP_OFFSET   =  0.4f;
const float  BRIDGE_THRESHOLD_G  =  0.5f;
const uint32_t BRIDGE_WINDOW_MS  = 3000;
const uint32_t BRIDGE_CLOSE_MS   =  300;
const uint32_t BRIDGE_OPEN_MS    = 2000;
...
void setup() {
    ...
    Serial.println("Manual Presisi ready. Kirim setpoint: s<gram>");
}
